...
class TestRetrainingCycle:
    ...
    def test_01_data_accumulator_creates_snapshots(self, docker_helper):
        ...
        assert wait_for_snapshots(docker_helper, min_snapshots=1, timeout=150), \
            "No snapshots created within 150 seconds"
    ...
    def test_02_first_retraining_cycle_completes(self, docker_helper):
        ...
        assert wait_for_retraining_cycle(docker_helper, cycle_number=1, timeout=180), \
            "First retraining cycle did not complete within 180 seconds"
    ...
    def test_03_combined_dataset_includes_unsw_and_synthetic(self, docker_helper):
        ...
        # Wait for retraining
        wait_for_retraining_cycle(docker_helper, cycle_number=1, timeout=180)
    ...
    def test_04_performance_tracked_across_cycles(self, docker_helper):
        ...
        assert wait_for_performance_metrics(docker_helper, min_rows=1, timeout=180), \
    ...
    def test_05_multiple_retraining_cycles(self, docker_helper):
        ...
        # Wait for 3 cycles
        assert wait_for_retraining_cycle(docker_helper, cycle_number=3, timeout=450), \
            "3 retraining cycles did not complete within 450 seconds"
